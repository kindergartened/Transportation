...
namespace Transportation
{
    public class Lib
    {
        ...
        public static string connectString = $"Provider=Microsoft.ACE.OLEDB.12.0;Data Source={DBPath}";
        ...
        /// <param name="values">значения</param>
        /// <param name="id">первичный ключ</param>
        public static void Update(string tableName, string[] values, int id)
        {
        ...
        /// <param name="values">значения</param>
        /// <returns>Отформатированные значения</returns>
        static string FormatNamesValues(string[] values)
        {
            string[] result = new string[names.Length - 1];
            for (int i = 1; i < names.Length; i++)
            {
                result[i - 1] = names[i] + " = " + $"'{values[i]}'";
            }
